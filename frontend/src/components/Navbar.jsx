      ...
      <div>
        <MenuButton className="">
          <div className="flex items-center gap-2">
            ...
            <MdOutlineKeyboardArrowDown className=" text-2xl text-gray-600 cursor-pointer dark:text-gray-300" />
          </div>
        </MenuButton>
      </div>
      ...
      <Popover className="">
        {({ open }) => (
          <>
            <PopoverButton
              className={`
               flex xl:hidden items-center rounded-md font-medium focus:outline-none text-gray-600 dark:text-gray-400`}
            >
              {open ? <MdOutlineClose size={26} /> : <IoIosMenu size={26} />}
            </PopoverButton>
            <TransitionWrapper>
              <PopoverPanel className="absolute z-50 w-screen max-w-sm px-4 py-6 mt-4 transform -translate-x-1/2 md:translate-x-0 bg-white left-1/2 dark:bg-slate-800">
...
const Navbar = () => {
  ...
  return (
    <div className={`sticky top-0 z-20 flex items-center justify-between w-full py-6 md:px-20 px-6  ${
